...
| `tavern/assets/tavern-og-table.jpg` | Share image, 1200x630, cropped from the Tavern table photo, in use from 12 September 2026 | Same original as `tavern-table-set.jpg` | Owned by Lewos |
